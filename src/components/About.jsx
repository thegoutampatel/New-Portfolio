  ...
  return (
    <section id="about">
      ...
      <div class="about--left">
        <h2>About Me</h2>
        <p class="about--text">
          I am currently an undergraduate student pursuing
          a <span id="about--degree">Bachelor of Technology in Computer Science and
            Engineering.</span> Alongside my studies, I am actively
          learning web development, specifically focusing
          on the MERN stack. My goal is to acquire the
