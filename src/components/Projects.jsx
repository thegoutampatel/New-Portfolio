...
const Projects = () => {
  return (
     <section id="projects">
        ...
        {/* <div class = "card">
            <img src="./Images/diceroll2.png" alt="">
            <div class="card-content">
              <h3>
                Dice Roller App
              </h3>
              <a href="https://dice-game-with-react.netlify.app/" id="link-icon" target="_blank"><i class="ri-links-line"></i></a>
              <a href="https://github.com/thegoutampatel/Dice-Game-with-React" id="card-github" target="_blank"><i class="ri-github-line"></i></a>
              <div id="tech">
                <h4>Tech ▻</h4>
                <i class="ri-html5-fill"></i>
                <i class="ri-css3-fill"></i>
